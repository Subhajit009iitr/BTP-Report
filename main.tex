...
\begin{document}
    ...
    \begin{titlepage}      
        \begin{center}
            \includegraphics[width=5cm]{figures/IITR_logo.png}\\[0.5cm]
            {\LARGE Indian Institute of Technology Roorkee\\[0.5cm]
			...
			%{\color{blue} \rule{\textwidth}{1pt}}
            {\Large 
                Abhay Kamath - 21114002      
            }\\
            {\Large 
                Akanksha Swati - 21114007      
            }\\
            {\Large 
                Subhajit Biswas - 21114100      
            }\\[1cm]
            ...
            {\large 
                ...
                \emph{Supervisor:} Dr. Sudip Roy}\\[1cm] % if applicable
            
    		% PLEASE DO NOT CHANGE THIS TEXT %
            \large A report submitted in partial fulfilment of the requirements of\\the Indian Institute of Technology, Roorkee for the degree of\\
            %%%
            %TODO:  verify your degree name
            Bachelor of Technology 
            %% 
            %TODO:  verify your degree in
            in \textit{Computer Science and Engineering}\\[0.3cm] 
            \vfill
